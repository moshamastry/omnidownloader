        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-slate-200/60 dark:border-white/5">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400">
              Developed with passion by <strong className="text-slate-900 dark:text-white font-bold">Mohammad Shamas</strong>. Follow on social media for updates, tools & support:
            </p>
            
            <div className="flex flex-wrap items-center gap-2.5 pt-1">
              {/* Instagram Creator Button */}
              <a
                href="https://www.instagram.com/mo.shamas"
                target="_blank"
                rel="noopener noreferrer"
                title="Follow @mo.shamas on Instagram"
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500">
          <p className="flex items-center gap-1">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-bold text-slate-800 dark:text-slate-200 hover:text-pink-500 dark:hover:text-pink-400 underline underline-offset-2 transition-colors"
            >
              Mohammad Shamas (@mo.shamas)
            </a>
          </p>
